...
async def start(bot, update):
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('💝 SUBSCRIBE TO MY CHANNEL', url='https://t.me/+gX6tWR1VWvUwOTRl')
            ],[
            InlineKeyboardButton('🔍 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ', url='https://t.me/HKOFFICIAL_D'),
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/+gX6tWR1VWvUwOTRl')
            ],[
...
# Ask Doubt on telegram @KingVJ01
    ...
    if not files_:
        ...
        try:
            ...
            title = '@HKOFFICIAL_1  ' + ' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@'), file.file_name.split()))
...
# Ask Doubt on telegram @KingVJ01
        ...
        buttons = [[
            InlineKeyboardButton('💝 JOIN MY CHANNEL ', url='https://t.me/+gX6tWR1VWvUwOTRl')
            ],[
            InlineKeyboardButton('🔍 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ', url='https://t.me/HKOFFICIAL_D'),
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/+gX6tWR1VWvUwOTRl')
            ],[
